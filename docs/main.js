...
var author$project$Model$Expr = F3(
	function (id, inputs, funcName) {
		return {funcName: funcName, id: id, inputs: inputs};
	});
...
var author$project$OnionToJson$twoNotesList = A2(
	...
	_List_fromArray(
		[
			...
			[
				...
				_Utils_Tuple2(
				'frequency',
				elm$json$Json$Encode$string('440'))
			]),
			_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'frequency',
				elm$json$Json$Encode$string('600'))
			])
		]));
var author$project$OnionToJson$testTogether = elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'type',
			elm$json$Json$Encode$string('together')),
			_Utils_Tuple2('notes', author$project$OnionToJson$twoNotesList)
		]));
				...
				A2(
					...
					_List_fromArray(
						[
							...
							author$project$OnionToJson$testTogether
						])))
			]));
};
...
var author$project$DrawProgram$createViewboxDimensions = F2(
	function (modelWidth, modelHeight) {
		var width = elm$core$String$fromInt((modelWidth / 5) | 0);
		var height = elm$core$String$fromInt((modelHeight / 5) | 0);
		return width + (' ' + height);
	});
...
var author$project$DrawProgram$drawProgram = function (model) {
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$String$fromInt(model.windowWidth)),
					elm$svg$Svg$Attributes$height(
					elm$core$String$fromInt(model.windowHeight)),
					elm$svg$Svg$Attributes$viewBox(
					'0 0 ' + A2(author$project$DrawProgram$createViewboxDimensions, model.windowWidth, model.windowHeight))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							elm$svg$Svg$Attributes$width(
							elm$core$String$fromInt((model.windowWidth / 20) | 0)),
							elm$svg$Svg$Attributes$height(
							elm$core$String$fromInt((model.windowHeight / 20) | 0)),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Title 1')
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							'Home',
							author$project$DrawProgram$drawProgram(model),
							model),
							A3(
							author$project$View$makePage,
							'Listings',
