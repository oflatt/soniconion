...
var author$project$Main$subscriptions = function (model) {
	return elm$browser$Browser$Events$onResize(author$project$Model$WindowResize);
};
...
var author$project$Model$Model = F8(
	function (currentPage, highlightedButton, urlkey, url, indexurl, windowWidth, windowHeight, program) {
		return {currentPage: currentPage, highlightedButton: highlightedButton, indexurl: indexurl, program: program, url: url, urlkey: urlkey, windowHeight: windowHeight, windowWidth: windowWidth};
	});
...
var author$project$SvgAssets$functionNameshape = F2(
	function (name, yPos) {
		return A3(
			elm$svg$Svg$node,
			'g',
...
var author$project$DrawProgram$drawBuiltIn = F2(
	function (builtIn, counter) {
		return A2(author$project$SvgAssets$functionNameshape, builtIn.waveType, counter * author$project$SvgAssets$blockSpacing);
	});
var author$project$DrawProgram$drawPlay = F2(
	function (play, counter) {
		return A2(author$project$SvgAssets$functionNameshape, 'play', counter * 200);
	});
var author$project$DrawProgram$drawExpression = F2(
	function (expr, counter) {
		if (expr.$ === 'BuiltInE') {
			var builtIn = expr.a;
			return A2(author$project$DrawProgram$drawBuiltIn, builtIn, counter);
		} else {
			var play = expr.a;
...
var author$project$DrawToolbar$builtInToSvg = F2(
	function (yPos, builtInSpec) {
		...
		var name = _n0.a;
		var nameList = _n0.b;
		return A2(author$project$SvgAssets$functionNameshape, name, yPos);
	});
