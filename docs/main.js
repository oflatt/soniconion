...
var author$project$Model$Wave = F2(
	function (inputs, waveType) {
		return {inputs: inputs, waveType: waveType};
	});
var author$project$Model$WaveE = function (a) {
	return {$: 'WaveE', a: a};
};
var author$project$Model$sine = A2(
	author$project$Model$Call,
	1,
	author$project$Model$WaveE(
		A2(
			author$project$Model$Wave,
			_Utils_Tuple2(
...
var author$project$Model$initialProgram = _List_fromArray(
	[
		_List_fromArray(
		[author$project$Model$sine, author$project$Model$play])
	]);
...
var author$project$OnionToJson$exprToJson = F2(
	function (expr, callDict) {
		if (expr.$ === 'WaveE') {
			var wave = expr.a;
			return A2(author$project$OnionToJson$waveToJson, wave, callDict);
		} else {
			var play = expr.a;
...
var author$project$OnionToJson$inputToJson = F2(
	function (input, callDict) {
		switch (input.$) {
			case 'Output':
				var id = input.a;
				var _n2 = A2(elm$core$Dict$get, id, callDict);
				if (_n2.$ === 'Just') {
					var call = _n2.a;
...
var author$project$OnionToJson$inputsToJson = F2(
	function (inputs, callDict) {
		return _Utils_Tuple2(
			A2(author$project$OnionToJson$inputToJson, inputs.a, callDict),
			A2(author$project$OnionToJson$inputToJson, inputs.b, callDict));
	});
...
var author$project$OnionToJson$waveToJson = F2(
	function (wave, callDict) {
		var inputsJsonRes = A2(author$project$OnionToJson$inputsToJson, wave.inputs, callDict);
		return A3(
					...
					return elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'wave',
								elm$json$Json$Encode$string(wave.waveType)),
								_Utils_Tuple2('duration', inputJson1),
								_Utils_Tuple2('frequency', inputJson2)
							]));
				}),
			inputsJsonRes.a,
			inputsJsonRes.b);
...
var author$project$DrawProgram$createViewboxDimensions = F2(
	function (modelWidth, modelHeight) {
		var width = elm$core$String$fromInt(600);
		var height = elm$core$String$fromInt(600);
		return width + (' ' + height);
	});
...
var author$project$View$programPage = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A3(author$project$DrawToolbar$drawToolBar, model, toolbarWidth, (model.windowHeight - author$project$View$titleHeight) - author$project$View$buttonHeight),
				A3(author$project$DrawProgram$drawProgram, model, (model.windowWidth - author$project$View$scrollbarWidth) - toolbarWidth, (model.windowHeight - author$project$View$titleHeight) - author$project$View$buttonHeight)
			]));
};
