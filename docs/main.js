...
var author$project$DrawProgram$drawCall = F3(
	function (call, counter, model) {
		return _Utils_eq(call.id, model.sel_id) ? A2(
			...
			_List_fromArray(
				[
					A2(author$project$DrawProgram$drawExpression, call.expr, counter)
				])) : A2(
			elm$svg$Svg$g,
			_List_fromArray(
				[
...
var author$project$DrawProgram$drawFunc = F3(
	function (func, counter, model) {
		if (!func.b) {
			...
			return A2(
				elm$core$List$cons,
				A3(author$project$DrawProgram$drawCall, call, counter, model),
				A3(author$project$DrawProgram$drawFunc, calls, counter + 1, model));
		}
	});
var author$project$DrawProgram$drawOnion = F2(
	function (onion, model) {
		if (!onion.b) {
			...
			var funcs = onion.b;
			return _Utils_ap(
				A3(author$project$DrawProgram$drawFunc, func, 0, model),
