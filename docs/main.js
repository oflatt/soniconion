	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				model.drag ? elm$browser$Browser$Events$onMouseMove(
				A2(elm$json$Json$Decode$map, author$project$Model$MouseMoved, author$project$Model$mouseDecoder)) : elm$core$Platform$Sub$none,
						...
						return function (windowHeight) {
							return function (program) {
								return function (start_x) {
									return function (start_y) {
										return function (dx) {
											return function (dy) {
												return function (sel_id) {
													return function (drag) {
														return {currentPage: currentPage, drag: drag, dx: dx, dy: dy, highlightedButton: highlightedButton, indexurl: indexurl, program: program, sel_id: sel_id, start_x: start_x, start_y: start_y, url: url, urlkey: urlkey, windowHeight: windowHeight, windowWidth: windowWidth};
													};
												};
											};
										};
...
var author$project$Model$BuiltIn = F2(
	function (inputs, waveType) {
		return {inputs: inputs, waveType: waveType};
	});
var author$project$Model$BuiltInE = function (a) {
	return {$: 'BuiltInE', a: a};
};
var author$project$Model$Call = F2(
	function (id, expr) {
...
var author$project$Model$join = A2(
	author$project$Model$Call,
	3,
	author$project$Model$BuiltInE(
		A2(
			author$project$Model$BuiltIn,
			_List_fromArray(
				[
					author$project$Model$Output(1),
					author$project$Model$Output(2)
				]),
			'join')));
var author$project$Model$Play = function (input) {
	return {input: input};
};
var author$project$Model$PlayE = function (a) {
	return {$: 'PlayE', a: a};
};
var author$project$Model$play = A2(
	author$project$Model$Call,
	1092392,
	author$project$Model$PlayE(
		author$project$Model$Play(
			author$project$Model$Output(3))));
var author$project$Model$Const = function (a) {
	return {$: 'Const', a: a};
};
var author$project$Model$sine = A2(
	author$project$Model$Call,
	1,
	author$project$Model$BuiltInE(
		A2(
			...
			'sine')));
var author$project$Model$sine2 = A2(
	author$project$Model$Call,
	2,
	author$project$Model$BuiltInE(
		A2(
	...
	function (flags, url, key) {
		return _Utils_Tuple2(
			author$project$Model$Model(
				...
				author$project$Model$getindexurl(url))(flags.innerWindowWidth)(flags.innerWindowHeight)(author$project$Model$initialProgram)(0)(0)(0)(0)(-1)(false),
...
var author$project$OnionToJson$specialMatched = F4(
	function (builtIn, callDict, inputsJson, argumentNames) {
		var _n0 = builtIn.waveType;
		switch (_n0) {
			case 'join':
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'wave',
										elm$json$Json$Encode$string(builtIn.waveType))
									]),
								tuples)));
				},
...
var author$project$OnionToJson$builtInWithInputs = F3(
	function (builtIn, callDict, inputsJson) {
		var getWave = A2(elm$core$Dict$get, builtIn.waveType, author$project$Model$waveFunctions);
		if (getWave.$ === 'Nothing') {
			var getSpecial = A2(elm$core$Dict$get, builtIn.waveType, author$project$Model$specialFunctions);
			if (getSpecial.$ === 'Nothing') {
				return elm$core$Result$Err('Not a built in function');
			} else {
				var specialArgs = getSpecial.a;
				return A4(author$project$OnionToJson$specialMatched, builtIn, callDict, inputsJson, specialArgs);
			}
		} else {
			var waveArgs = getWave.a;
			return A4(author$project$OnionToJson$waveMatched, builtIn, callDict, inputsJson, waveArgs);
		}
	});
...
var author$project$OnionToJson$builtInToJson = F2(
	function (builtIn, callDict) {
		var inputsJsonRes = A2(author$project$OnionToJson$inputsToJson, builtIn.inputs, callDict);
		if (inputsJsonRes.$ === 'Err') {
			var e = inputsJsonRes.a;
			return elm$core$Result$Err(e);
		} else {
			var o = inputsJsonRes.a;
			return A3(author$project$OnionToJson$builtInWithInputs, builtIn, callDict, o);
		}
	});
var author$project$OnionToJson$callToJson = F2(
	function (call, callDict) {
		return A2(author$project$OnionToJson$exprToJson, call.expr, callDict);
	});
var author$project$OnionToJson$exprToJson = F2(
	function (expr, callDict) {
		if (expr.$ === 'BuiltInE') {
			var builtIn = expr.a;
			return A2(author$project$OnionToJson$builtInToJson, builtIn, callDict);
		} else {
			var play = expr.a;
			return A2(author$project$OnionToJson$playToJson, play, callDict);
		}
	});
var author$project$OnionToJson$inputToJson = F2(
	function (input, callDict) {
		switch (input.$) {
			case 'Output':
				var id = input.a;
				var _n3 = A2(elm$core$Dict$get, id, callDict);
				if (_n3.$ === 'Just') {
					var call = _n3.a;
...
var author$project$OnionToJson$playToJson = F2(
	function (play, callDict) {
		var _n0 = play.input;
		switch (_n0.$) {
			case 'Const':
				var c = _n0.a;
				return elm$core$Result$Err('Play got a const');
			case 'Hole':
				return elm$core$Result$Err('Incomplete program - Play requires a value');
			default:
				var o = _n0.a;
				return A2(author$project$OnionToJson$inputToJson, play.input, callDict);
		}
	});
...
var author$project$OnionToJson$functionToJson = function (_function) {
	...
	var _n0 = author$project$Utils$last(_function);
	if (_n0.$ === 'Just') {
		var playCall = _n0.a;
...
var author$project$Update$mouse_scale_x = function (mouse_x) {
	return elm$core$Basics$round(mouse_x * 1.65);
};
var author$project$Update$mouse_scale_y = function (mouse_y) {
	return elm$core$Basics$round(mouse_y * 1.65);
};
...
var author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MouseMoved':
				var pos = msg.a;
				return _Utils_eq(model.start_x, -1) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dx: 0,
							dy: 0,
							start_x: author$project$Update$mouse_scale_x(pos.x),
							start_y: author$project$Update$mouse_scale_y(pos.y)
						}),
					elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dx: author$project$Update$mouse_scale_x(pos.x) - model.start_x,
							dy: author$project$Update$mouse_scale_y(pos.y) - model.start_y
						}),
					elm$core$Platform$Cmd$none);
			case 'Move':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{drag: true, sel_id: id, start_x: -1, start_y: -1}),
					A2(
						elm$core$Debug$log,
...
var author$project$View$pageColor = A3(rtfeldman$elm_css$Css$rgb, 247, 247, 222);
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$backgroundColor(author$project$View$pageColor)
						]))
				]),
			_List_fromArray(
...
var author$project$View$titleHeight = 90;
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$height(
					rtfeldman$elm_css$Css$px(author$project$View$titleHeight)),
...
var author$project$View$buttonHeight = 50;
var author$project$View$pageBackgroundColor = A3(rtfeldman$elm_css$Css$rgb, 229, 229, 208);
...
var author$project$View$pagebutton = F2(
	function (pageName, model) {
		var buttonPageColor = _Utils_eq(pageName, model.currentPage) ? author$project$View$pageColor : author$project$View$pageBackgroundColor;
		return A2(
			rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$height(
							rtfeldman$elm_css$Css$px(author$project$View$buttonHeight)),
...
var author$project$SvgAssets$drawDots = F3(
	function (num, xpos, ypos) {
		return (num <= 0) ? _List_Nil : A2(
			elm$core$List$cons,
			A2(
				elm$svg$Svg$circle,
				_List_fromArray(
				...
				_List_Nil),
			A3(author$project$SvgAssets$drawDots, num - 1, xpos + 40, ypos));
	});
var author$project$SvgAssets$drawNames = function (l) {
	return _List_Nil;
};
var author$project$SvgAssets$getArgCircles = F2(
	function (argList, ypos) {
		if (argList.$ === 'Infinite') {
			var min = argList.a;
			return A3(author$project$SvgAssets$drawDots, min, 20, ypos);
		} else {
			var l = argList.a;
			return _Utils_ap(
				author$project$SvgAssets$drawNames(l),
				A3(
					author$project$SvgAssets$drawDots,
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					'translate(' + ('30,' + (elm$core$String$fromInt(author$project$SvgAssets$paddingSize + yPos) + ')')))
				]),
			_Utils_ap(
				_List_fromArray(
					[
...
var author$project$DrawProgram$drawCall = F4(
	function (call, counter, idToPos, model) {
		return _Utils_eq(call.id, model.sel_id) ? A2(
			elm$svg$Svg$g,
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$transform(
					'translate(' + (elm$core$String$fromInt(model.dx) + (',' + (elm$core$String$fromInt(model.dy) + ')')))),
					elm$svg$Svg$Events$onMouseDown(
					author$project$Model$Move(call.id))
				]),
			_List_fromArray(
				[
					A3(author$project$DrawProgram$drawExpression, call.expr, counter, idToPos)
				])) : A2(
			elm$svg$Svg$g,
			_List_fromArray(
				[
...
var author$project$DrawProgram$drawFunc = F4(
	function (func, counter, idToPos, model) {
		if (!func.b) {
			return _List_Nil;
		} else {
			var call = func.a;
			...
			return A2(
				elm$core$List$cons,
				A4(author$project$DrawProgram$drawCall, call, counter, idToPos, model),
				A4(author$project$DrawProgram$drawFunc, calls, counter + 1, idToPos, model));
		}
	});
...
var author$project$DrawProgram$drawOnion = F2(
	function (onion, model) {
		if (!onion.b) {
			return _List_Nil;
		} else {
			var func = onion.a;
			...
			return _Utils_ap(
				A4(
					...
					model),
				A2(author$project$DrawProgram$drawOnion, funcs, model));
		}
	});
var author$project$SvgAssets$createViewboxDimensions = F2(
	function (w, h) {
		var width = elm$core$String$fromInt(w);
		var height = elm$core$String$fromInt(h);
		return width + (' ' + height);
	});
var author$project$SvgAssets$viewportHeight = 600;
var author$project$SvgAssets$viewportWidth = 600;
...
var author$project$DrawProgram$drawProgram = F3(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						'0 0 ' + A2(author$project$SvgAssets$createViewboxDimensions, author$project$SvgAssets$viewportWidth, author$project$SvgAssets$viewportHeight)),
						elm$svg$Svg$Attributes$display('inline-block')
					]),
				A2(author$project$DrawProgram$drawOnion, model.program, model)));
	});
var author$project$DrawToolbar$builtInToSvg = F2(
	function (yPos, builtInSpec) {
		var _n0 = builtInSpec;
		var name = _n0.a;
		var nameList = _n0.b;
		return A3(
...
var author$project$DrawToolbar$allBuiltInFunctions = F4(
	function (offset, twidth, theight, funcList) {
		if (!funcList.b) {
			...
			return A2(
				elm$core$List$cons,
				A2(author$project$DrawToolbar$builtInToSvg, offset, f),
				A4(author$project$DrawToolbar$allBuiltInFunctions, offset + author$project$SvgAssets$blockSpacing, twidth, theight, fs));
		}
	});
var author$project$DrawToolbar$toolBarSvg = F3(
		...
		return rtfeldman$elm_css$Html$Styled$fromUnstyled(
			A2(
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$width(
						elm$core$String$fromInt(twidth)),
						elm$svg$Svg$Attributes$height(
						elm$core$String$fromInt(theight)),
						elm$svg$Svg$Attributes$viewBox(
						'0 0 ' + A2(
							author$project$SvgAssets$createViewboxDimensions,
							elm$core$Basics$round(author$project$SvgAssets$viewportWidth / 2),
							author$project$SvgAssets$viewportHeight))
					]),
				A4(author$project$DrawToolbar$allBuiltInFunctions, author$project$SvgAssets$paddingSize, twidth, theight, author$project$Model$builtInFunctionList)));
	});
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$width(
							rtfeldman$elm_css$Css$px(twidth)),
							rtfeldman$elm_css$Css$height(
							rtfeldman$elm_css$Css$px(theight)),
							rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$inlineBlock)
						]))
				]),
			_List_fromArray(
				[
					A3(author$project$DrawToolbar$toolBarSvg, model, twidth, theight)
				]));
	});
var author$project$View$scrollbarWidth = 40;
var author$project$View$toolbarProportion = 0.25;
var author$project$View$programPage = function (model) {
	var toolbarWidth = elm$core$Basics$round(author$project$View$toolbarProportion * model.windowWidth);
	var programHeight = ((model.windowHeight - author$project$View$titleHeight) - author$project$View$buttonHeight) - author$project$View$scrollbarWidth;
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(author$project$DrawToolbar$drawToolBar, model, toolbarWidth, programHeight),
				A3(author$project$DrawProgram$drawProgram, model, (model.windowWidth - author$project$View$scrollbarWidth) - toolbarWidth, programHeight)
			]));
};
