...
makeTitle model = (div
                   ...
                   ,(div[css[
                         ...
                         ,(makeIconButton stopIcon "Stop" (PlaySound)
                               (if not (model.highlightedButton == "Stop")
                         ...
                         ,(div [css [fontFamilies ["monospace"]
                                    ...
                                    ,fontSize (px 24)
                                    ,marginLeft (px 100)]]
                               [text ("fps: " ++ (String.fromInt model.fps))])
