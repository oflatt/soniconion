...
var $author$project$ViewStructure$makeBlockPosition = F4(
	function (xpos, ypos, call, shouldCenter) {
...
var $author$project$ViewStructure$movedInfoBlockPos = function (moveInfo) {
	return A4($author$project$ViewStructure$makeBlockPosition, moveInfo.movedPos.a, moveInfo.movedPos.b, moveInfo.movedCall, true);
};
			...
			var blockPos = function () {
				if (isMoved) {
					if (maybeMoveInfo.$ === 'Just') {
						...
						return A4($author$project$ViewStructure$makeBlockPosition, 0, 0, call, false);
					}
				} else {
					return A4(
...
var $author$project$ViewPositions$getViewStructures = F4(
	function (onion, mouseState, svgWindowWidth, svgWindowHeight) {
		...
		return A8($author$project$ViewPositions$recursivePosition, $author$project$ViewVariables$funcInitialX, $author$project$ViewVariables$funcInitialY, selected, moved, mouseState, svgWindowWidth, svgWindowHeight, onion);
	});
...
var $author$project$Update$programDropped = function (model) {
	...
	var viewStructures = A4($author$project$ViewPositions$getViewStructures, model.program, model.mouseState, svgW, svgH);
	return A2(
		$elm$core$List$map,
		function ($) {
			return $.sortedFunc;
